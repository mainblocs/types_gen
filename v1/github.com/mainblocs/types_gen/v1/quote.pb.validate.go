...
// Validate checks the field values on ShipmentInfo with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *ShipmentInfo) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ShipmentInfo with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ShipmentInfoMultiError, or
// nil if none found.
func (m *ShipmentInfo) ValidateAll() error {
	return m.validate(true)
}

func (m *ShipmentInfo) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for ShipmentType
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ShipmentInfoValidationError{
					field:  "Business",
		...
		if err := v.Validate(); err != nil {
			return ShipmentInfoValidationError{
				field:  "Business",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	// no validation rules for ShipmentValue

	// no validation rules for TotalLength

	// no validation rules for TotalWidth

	// no validation rules for TotalHeight

	// no validation rules for PickupReadyTime

	if len(errors) > 0 {
		return ShipmentInfoMultiError(errors)
	}

	return nil
}

// ShipmentInfoMultiError is an error wrapping multiple validation errors
// returned by ShipmentInfo.ValidateAll() if the designated constraints aren't met.
type ShipmentInfoMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ShipmentInfoMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m ShipmentInfoMultiError) AllErrors() []error { return m }

// ShipmentInfoValidationError is the validation error returned by
// ShipmentInfo.Validate if the designated constraints aren't met.
type ShipmentInfoValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e ShipmentInfoValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ShipmentInfoValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ShipmentInfoValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ShipmentInfoValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ShipmentInfoValidationError) ErrorName() string { return "ShipmentInfoValidationError" }

// Error satisfies the builtin error interface
func (e ShipmentInfoValidationError) Error() string {
	cause := ""
	if e.cause != nil {
...
var _ error = ShipmentInfoValidationError{}
...
func (m *QuoteRequest) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetShipmentInfo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
	...
	} else if v, ok := interface{}(m.GetShipmentInfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
