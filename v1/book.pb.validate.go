...
func (m *BookingInfo) validate(all bool) error {
	...
	// no validation rules for FirstShipperReferences

	// no validation rules for CarrierPickupNumber

	// no validation rules for ServiceType

	// no validation rules for BolUrl

	// no validation rules for ProNumberSvgUrl

	// no validation rules for CarrierQuoteNumber

	// no validation rules for PickupDate

	// no validation rules for CarrierReferences

	// no validation rules for TransitDays

	// no validation rules for Platform

	// no validation rules for BolGenerated
